"""
Django settings for test_case_stripe project.
...
MIDDLEWARE = [
    ...
    'product.middleware.set_user_id_cookie',
]

ROOT_URLCONF = 'test_case_stripe.urls'
...
WSGI_APPLICATION = 'test_case_stripe.wsgi.application'
